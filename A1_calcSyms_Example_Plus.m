...
% syms phi1
% L1=subs(L,ph_i(1),phi1);
% L1=subs(L,phi1(t),phi1);


laStr_K=convertTddotTeXF(K)
laStr_U=convertTddotTeXF(U)

laStr_L=convertTddotTeXF(L)
laStr_dL=convertTddotTeXF(diff(L,t))
