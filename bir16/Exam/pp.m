...
p1= @(x) ((x-x1).*(x-x2).*(x-x3))/((x0-x1).*(x0-x2).*(x0-x3))*f0+...
     ...
     p1= @(x) ((x-x1).*(x-x2).*(x-x3).*(x-x4))/((x0-x1).*(x0-x2).*(x0-x3).*(x0-x4))*f0+...
         ((x-x0).*(x-x2).*(x-x3).*(x-x4))/((x1-x0).*(x1-x2).*(x1-x3).*(x1-x4))*f1+...
         ((x-x0).*(x-x1).*(x-x3).*(x-x4))/((x2-x0).*(x2-x1).*(x2-x3).*(x2-x4))*f2+ ...
         ((x-x0).*(x-x1).*(x-x2).*(x-x4))/((x3-x0).*(x3-x1).*(x3-x2).*(x3-x4))*f3+...
         ((x-x0).*(x-x1).*(x-x2).*(x-x4))/((x4-x0).*(x4-x1).*(x4-x2).*(x4-x3))*f4;
...
% expand(p1(x))
(3*xa*(xa - 1)*(xa - 3)*(xa - 4))/4 - (xa*(xa - 1)*(xa - 2)*(xa - 4))/3 - (xa*(xa - 2)*(xa - 3)*(xa - 4))/6
