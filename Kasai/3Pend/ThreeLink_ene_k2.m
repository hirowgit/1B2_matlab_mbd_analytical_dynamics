...
%運動エネルギー
K1=(d_theta(1)^2*(m(1)*Lg(1)^2 + Ic(1)))/2;
K2=(m(2)*L(1)^2*d_theta(1)^2)/2 + m(2)*cos(theta(2))*L(1)*Lg(2)*d_theta(1)^2 + m(2)*cos(theta(2))*L(1)*Lg(2)*d_theta(1)*d_theta(2) + (m(2)*Lg(2)^2*d_theta(1)^2)/2 + m(2)*Lg(2)^2*d_theta(1)*d_theta(2) + (m(2)*Lg(2)^2*d_theta(2)^2)/2 + (Ic(2)*d_theta(1)^2)/2 + Ic(2)*d_theta(1)*d_theta(2) + (Ic(2)*d_theta(2)^2)/2;
K3=m(3)*(Lg(3)*d_theta(1)*cos(theta(1) + theta(2) + theta(3)) + Lg(3)*d_theta(2)*cos(theta(1) + theta(2) + theta(3)) + Lg(3)*d_theta(3)*cos(theta(1) + theta(2) + theta(3)) + L(2)*d_theta(1)*cos(theta(1) + theta(2)) + L(2)*d_theta(2)*cos(theta(1) + theta(2)) + L(1)*d_theta(1)*cos(theta(1))^2)/2 + (Ic(3)*(d_theta(1) + d_theta(2) + d_theta(3))^2)/2 + (m(3)*(Lg(3)*d_theta(1)*sin(theta(1) + theta(2) + theta(3)) + Lg(3)*d_theta(2)*sin(theta(1) + theta(2) + theta(3)) + Lg(3)*d_theta(3)*sin(theta(1) + theta(2) + theta(3)) + L(2)*d_theta(1)*sin(theta(1) + theta(2)) + L(2)*d_theta(2)*sin(theta(1) + theta(2)) + L(1)*d_theta(1)*sin(theta(1)))^2)/2;
